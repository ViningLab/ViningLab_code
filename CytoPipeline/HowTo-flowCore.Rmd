...
https://doi.org/10.1002%2Fcpim.40


## Reading and Manipulating flowCore Data Classes
...
#  p <- p + scale_fill_viridis_c( begin = 0.1, end = 0.99, option = "C" )
  p <- p + scale_fill_viridis_c( begin = 0.15, end = 0.99, option = "C" )
  p <- p + theme_bw()
  p <- p + xlab( sample1 )
...
If you do not have the package 'flowWorkspaceData' installed you will need to in order to access the example data.
The below commands should install it for you.
...
smaller <- Subset(fs[[1]], rectGate)
autoplot(fs[[1]], "FL1-H")
#autoplot(result, "FL1-H")
autoplot(smaller, "FL1-H")

autoplot(smaller, "FL1-H", "FL2-H")
...
autoplot(fs[[1]], "FL1-H")
autoplot(smaller[[1]], "FL1-H")
autoplot(smaller[[1]], "FL2-H")
...
## Extensions from flowWorkspace: GatingHierarchy and GatingSet


This section relies on data structures that I do not believe we have access to outside of the 'flowWorkspace' package.
